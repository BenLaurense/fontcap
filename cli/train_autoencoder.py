...
"""
Click command for training the autoencoder. Usage (from project root with venv):
python -m cli.train_autoencoder -dr "data/fonts" -ep 2 -bs 32 -lr 0.001 -chkdir "./something" -chki 1 -pi 1
"""
logging.basicConfig(
